...
classes, num_text_aug, text_dict = text_prompt_4part_carepd()

text_list = text_prompt_carepd()
...
def get_parser():
    ...
    parser.add_argument(
        '--config',
        default='./config/care-pd/test_bone.yaml',
...
class Processor():
    ...
    def eval(self, epoch, save_score=False, loader_name=['test'], wrong_file=None, result_file=None):
        ...
        for ln in loader_name:
            ...
            with open('{}/test_class_acc.csv'.format(self.arg.work_dir), 'w') as f:
                writer = csv.writer(f)
